...
import com.pemaseervi.myretailer.Adapter.ProductSpecificationAdapter;
...
public class ProductSpecificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productSpecificationRecycleView= view.findViewById(R.id.product_specification_recycler_view);
